...
class RZP_Route extends WP_List_Table {
    ...
    function rzp_transfers()
    {
        ...
        echo '<button class="btn btn-primary" onclick="'.$show.'">Create Direct Transfer</button>';
        $this->prepare_items();
...
//            echo '<pre>'; print_r($transfer_detail); echo '</pre>';
//            echo $prev_url; exit;
            echo '<div class="wrap">
            ...
            <div class="container rzp-container">
                ...
                <div class="row panel-body">
                    <div class="col-md-12 panel-body-left">
                        ...
                        <div class="row">
                            <div class="col-sm-4 panel-label">Settlement</div>
                            <div class="col-sm-8 panel-value">';
                                    ...
                                    elseif($transfer_detail['on_hold'] == 1 && $transfer_detail['on_hold_until'] ==''){
                                        echo '<span class="text-danger trf-status">On Hold</span>';
                                        echo '<span><a href="javascript:void(0);" onclick="'.$show_setl.'" >Change</a></span>';
                                    }elseif ($transfer_detail['on_hold'] == 0 && $transfer_detail['recipient_settlement_id'] ==''){
                                        echo '<span class="text-success trf-status">Pending</span>';
                                        echo '<span><a href="javascript:void(0);" onclick="'.$show_setl.'" >Change</a></span>';
                                    }else{
                                        echo '<span>'.ucfirst($transfer_detail['recipient_settlement']['status']).'</span>';
                                    }
                        ...
                        <div class="row">
                            ...
                            echo '<button onclick="'. $show .'" class="btn btn-primary">Create Reversal</button>'; } echo '</div>
                        </div>
                        <div class="row">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="'.esc_url( admin_url('admin-post.php') ).'">
                ...
                <div class="input-group"><div class="input-group-addon">INR</div>
                <div class="InputField ">
                <input name="reversal_amount" type="number" autocomplete="off" class="form-control" placeholder="Enter the reversal amount">
                </div>
                </div></div>

                <div>

                <button type="submit" onclick="'.$hide.'" name="create_reversal"  class="btn btn-primary">Create Reversal</button>
...
echo $transfer_settlement_modal;
    ...
    function route_header(){
        ...
        <a <?php if($_GET['page'] == "razorpay_route_woocommerce"){ ?> class="active" <?php } ?>  href="?page=razorpay_route_woocommerce">Transfers</a>
        <a <?php if($_GET['page'] == "razorpay_route_payments"){ ?> class="active" <?php } ?> href="?page=razorpay_route_payments">Payments</a>
        <a <?php if($_GET['page'] == "razorpay_route_reversals"){ ?> class="active" <?php } ?> href="?page=razorpay_route_reversals">Reversals</a>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="'.esc_url( admin_url('admin-post.php') ).'">
                ...
                <div class="input-group"><div class="input-group-addon">INR</div>
                <div class="InputField ">
                <input name="pay_trf_amount" type="number" autocomplete="off" class="form-control" placeholder="Enter amount">
                </div>
                </div></div>
                <div class="form-group"><label>Account Number</label>
                <div class="InputField ">
